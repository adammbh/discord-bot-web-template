                    ...
                    <div className="bg-[#0F0F0F]/90 backdrop-blur-md shadow-lg rounded-full py-2 px-3 sm:py-2.5 sm:px-5 transition-all duration-1000 ease-[cubic-bezier(0.22,1,0.36,1)]">
                        <div className="flex items-center justify-between sm:justify-start gap-2 sm:gap-3 transition-all duration-1000 ease-[cubic-bezier(0.22,1,0.36,1)]">
                            <Link href="/" className="flex-shrink-0">
                                <Image
                                    src="https://r2.yourbot.bot/yourbot-marketing.png"
                                    alt="yourbot"
                                    width={26}
                                    height={26}
                            ...
                            <div className="hidden md:flex items-center gap-3">
                                ...
                                <Link
                                    href="/invite"
                                    className={`relative transform-gpu will-change-transform transition-all duration-1000 ease-[cubic-bezier(0.22,1,0.36,1)] bg-yourbot-primary text-yourbot-100 hover:bg-opacity-90 rounded-full font-medium text-sm flex items-center justify-center overflow-hidden ${
                            ...
                            <div className="flex items-center gap-2 sm:gap-3 md:hidden">
                                <Link
                                    href="/invite"
                                    className="bg-yourbot-primary hover:bg-opacity-90 text-yourbot-100 rounded-full font-medium text-sm flex items-center justify-center w-8 h-8 sm:w-9 sm:h-9 transition-all">
                                    <DiscordIcon />
                                </Link>
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                                <Link
                                                    ...
                                                    <div className="p-2 rounded-lg bg-white/5 border border-yourbot-primary/20">
                                                        <Shield className="w-5 h-5 text-yourbot-primary/80" />
                                                    </div>
                                                    <div>
                                                ...
                                                <Link
                                                    ...
                                                    onClick={() => setIsMobileMenuOpen(false)}>
                                                    <div className="p-2 rounded-lg bg-white/5 border border-yourbot-primary/20">
                                                        <Music className="w-5 h-5 text-yourbot-primary/80" />
                                                    </div>
                                                    <div>
                                                ...
                                                <Link
                                                    ...
                                                    onClick={() => setIsMobileMenuOpen(false)}>
                                                    <div className="p-2 rounded-lg bg-white/5 border border-yourbot-primary/20">
                                                        <Wallet className="w-5 h-5 text-yourbot-primary/80" />
                                                    </div>
                                                    <div>
                                                ...
                                                <Link
                                                    ...
                                                    onClick={() => setIsMobileMenuOpen(false)}>
                                                    <div className="p-2 rounded-lg bg-white/5 border border-yourbot-primary/20">
                                                        <Gift className="w-5 h-5 text-yourbot-primary/80" />
                                                    </div>
                                                    <div>
                                                ...
                                                <Link
                                                    ...
                                                    onClick={() => setIsMobileMenuOpen(false)}>
                                                    <div className="p-2 rounded-lg bg-white/5 border border-yourbot-primary/20">
                                                        <Bot className="w-5 h-5 text-yourbot-primary/80" />
                                                    </div>
                                                    <div>
                                        ...
                                        <div className="p-4">
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                                <Link
                                                    ...
                                                    onClick={() => setIsMobileMenuOpen(false)}>
                                                    <div className="p-2 rounded-lg bg-white/5 border border-yourbot-primary/20">
                                                        <Code className="w-5 h-5 text-yourbot-primary/80" />
                                                    </div>
                                                    <div>
                                                ...
                                                <a
                                                    ...
                                                    onClick={() => setIsMobileMenuOpen(false)}>
                                                    <div className="p-2 rounded-lg bg-white/5 border border-yourbot-primary/20">
                                                        <FileText className="w-5 h-5 text-yourbot-primary/80" />
                                                    </div>
                                                    <div>
                                                        <div className="font-medium text-white mb-1">Documentation</div>
                                                        <p className="text-xs text-zinc-400">Learn how to use yourbot</p>
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
