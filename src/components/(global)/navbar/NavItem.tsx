    ...
    if (label === "Features") {
        return (
            <div
                ...
                <button className={`font-medium flex items-center gap-1 transition-colors ${isActive ? "text-yourbot-primary" : "text-[#71767C] hover:text-[#8B8F95]"}`}>
                    {label}
                    <motion.div
                        ...
                        <motion.div
                            ...
                            <div className="p-4 grid grid-cols-[240px,1fr] gap-4">
                                <Link
                                    ...
                                    <div className="text-xs text-zinc-500 mt-3 group-hover:text-yourbot-primary/60 transition-colors">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <Link
                                        ...
                                        <div className="text-xs text-zinc-500 group-hover:text-yourbot-primary/60 transition-colors">
                                            Learn more →
                                        </div>
                                    </Link>
