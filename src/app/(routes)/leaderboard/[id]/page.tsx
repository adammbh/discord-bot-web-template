...
export default function LeaderboardPage({ params }: PageProps) {
    ...
    function UserCard({
        ...
        return (
            <div
                className={`
                relative bg-yourbot-200 border border-yourbot-card-border rounded-xl p-6
            ...
            `}>
                    ...
                    ${
                        rank === 1
                            ...
                            : rank === 2
                              ...
                              : rank === 3
                                ? "bg-amber-700"
                                : "bg-yourbot-400 border border-yourbot-card-border"
                    }
                `}>
                ...
                <div className="flex items-center gap-4 ml-6">
                    <div className="relative w-12 h-12 rounded-full overflow-hidden border-2 border-yourbot-card-border">
                        <Image
                            src={avatarSrc}
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <div className="mt-2">
                            ...
                            <div className="h-1.5 bg-yourbot-400 rounded-full overflow-hidden">
                                <div
    ...
    function RoleList({ roles }: { roles: Role[] }) {
        ...
        return (
            <div className="bg-yourbot-200 border border-yourbot-card-border rounded-xl p-6 mb-8">
                <div
                ...
                {isOpen && (
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        {Object.entries(groupedRoles).map(([level, rolesForLevel]) => (
                            <div
                                key={level}
                                className="bg-yourbot-400 rounded-lg p-4 border border-yourbot-card-border">
