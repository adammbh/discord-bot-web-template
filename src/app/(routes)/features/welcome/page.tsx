                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-24 pt-24 relative">
                    <motion.div
                        ...
                        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4 md:mb-6 mt-12">
                            <span className="bg-clip-text text-transparent bg-gradient-to-r from-white to-yourbot-primary">
                                Welcome System
                            </span>
                        </h1>
                        ...
                        <motion.div
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center gap-3 mb-4">
                                    <div className="p-2.5 rounded-lg bg-white/5 border border-yourbot-primary/20">
                                        <feature.icon className="w-5 h-5 text-yourbot-primary/80" />
                                    </div>
                                    <h3 className="text-lg font-medium text-yourbot-primary/90">{feature.title}</h3>
                                </div>
                                <p className="text-white/60 text-sm">{feature.description}</p>
                            </div>
                            <div className="absolute inset-0 bg-gradient-to-br from-yourbot-primary/5 to-transparent 
                    ...
                    <div className="bg-white/[0.02] backdrop-blur-md backdrop-saturate-150 rounded-3xl border border-white/[0.05] overflow-hidden">
                        <div className="border-b border-white/5 p-6">
                            <div className="flex items-center gap-3 mb-3">
                                <div className="p-2.5 rounded-lg bg-white/5 border border-yourbot-primary/20">
                                    <Variable className="w-5 h-5 text-yourbot-primary/80" />
                                </div>
                        ...
                        <div className="p-6">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                <div>
                                    <h3 className="text-lg font-medium text-yourbot-primary/90 mb-4">
                                        User Variables
                                    </h3>
                                    <div className="space-y-3">
                                        {[
                                            ...
                                            <div key={index} className="group bg-black/20 rounded-lg p-3 hover:bg-black/30 transition-colors border border-white/5">
                                                <code className="text-sm font-mono text-yourbot-primary/80">
                                                    {item.variable}
                                                </code>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="group relative bg-white/[0.02] backdrop-blur-md backdrop-saturate-150 rounded-3xl border border-white/[0.05] overflow-hidden hover:bg-white/[0.04] transition-all duration-300">
                            <div className="border-b border-white/5 p-6">
                                <div className="flex items-center gap-3">
                                    <div className="p-2.5 rounded-lg bg-white/5 border border-yourbot-primary/20">
                                        <Settings className="w-5 h-5 text-yourbot-primary/80" />
                                    </div>
                                    <h3 className="text-xl font-medium text-yourbot-primary/90">
                                        Dashboard Setup
                                    </h3>
                                </div>
                            </div>
                            <div className="p-6">
                                ...
                                <Link href="/dashboard">
                                    <button className="px-6 py-3 bg-yourbot-primary text-yourbot-100 rounded-xl font-medium hover:bg-opacity-90 transition-all flex items-center justify-center gap-2">
                                        Open Dashboard
                        ...
                        <div className="group relative bg-white/[0.02] backdrop-blur-md backdrop-saturate-150 rounded-3xl border border-white/[0.05] overflow-hidden hover:bg-white/[0.04] transition-all duration-300">
                            <div className="border-b border-white/5 p-6">
                                <div className="flex items-center gap-3">
                                    <div className="p-2.5 rounded-lg bg-white/5 border border-yourbot-primary/20">
                                        <Command className="w-5 h-5 text-yourbot-primary/80" />
                                    </div>
                                    <h3 className="text-xl font-medium text-yourbot-primary/90">Command Setup</h3>
                                </div>
                            </div>
                            <div className="p-6">
                                <p className="text-white/60 mb-4">
                ...
                <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} className="mb-20">
                    <div className="bg-white/[0.02] backdrop-blur-md backdrop-saturate-150 rounded-3xl border border-white/[0.05] overflow-hidden">
                        <div className="border-b border-white/5 p-6">
                            <div className="flex items-center gap-3 mb-3">
                                <div className="p-2.5 rounded-lg bg-white/5 border border-yourbot-primary/20">
                                    <MessageSquare className="w-5 h-5 text-yourbot-primary/80" />
                                </div>
                        ...
                        <div className="p-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="bg-black/20 rounded-lg p-4 border border-yourbot-primary/20">
                                    <div className="flex items-start gap-4">
                                        <img
                                            src="/avs/yourbot-dc.png"
                                            alt="User Avatar"
                                ...
                                <div className="bg-black/20 rounded-lg p-4 border border-yourbot-primary/20">
                                    <div className="text-center">
                                        <img
                                            src="/avs/yourbot.png"
                                            alt="User Avatar"
                                            className="w-20 h-20 rounded-full mx-auto mb-4 ring-4 ring-yourbot-primary/20"
                                        />
                                        <h3 className="text-xl font-bold text-white mb-2">
                                            Welcome to the server!
                                        </h3>
                                        <p className="text-white/80 mb-4">
                                            Hey <span className="text-yourbot-primary">@yourbot</span>!
                                            Thanks for joining. You&apos;re our 1,234th member!
                                        </p>
                                        <div className="flex justify-center gap-2 text-sm">
                                            <span className="px-3 py-1 bg-yourbot-primary/20 rounded-full text-yourbot-primary">
                                                Member #1234
                                            </span>
                                            <span className="px-3 py-1 bg-yourbot-primary/20 rounded-full text-yourbot-primary">
                                                New Member
                        ...
                        <div className="flex flex-col lg:flex-row items-center gap-8 mt-8">
                            <div className="flex-1 space-y-4">
                                <p className="text-white/60 text-xl">
                                    Join thousands of servers using yourbot&apos;s welcome system
                                </p>
                                <div className="flex flex-wrap gap-6 justify-center lg:justify-start text-white/40">
                                    <div className="flex items-center gap-2">
                                        <Wand2 className="w-5 h-5 text-yourbot-primary" />
                                        Custom messages
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <Variable className="w-5 h-5 text-yourbot-primary" />
                                        Dynamic variables
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <Palette className="w-5 h-5 text-yourbot-primary" />
                                        Rich embeds
                                    </div>
                                </div>
                            </div>
