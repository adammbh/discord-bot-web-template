    ...
    return (
        <button
            ...
            className={`relative inline-flex h-5 w-9 items-center rounded-full transition-colors ${
                checked ? "bg-yourbot-pink" : "bg-white/10"
            }`}>
            <span
...
export default function ModerationFeature() {
    ...
    const [modLogs, setModLogs] = useState([
        {
            caseNumber: "xxx",
            type: "xxx",
            user: { id: "xxx", name: "yourbot", avatar: "/yourbot.png" },
            moderator: { id: "xxx", name: "yourbot" },
            reason: "xxx"
        }
    ])
    ...
    const demoScenarios = {
        spam: {
            ...
            description: "See how yourbot automatically detects and prevents spam messages",
            action: () => {
                const spamMessages = [
        ...
        antinuke: {
            ...
            description: "See how yourbot protects against server nuking attempts",
            action: () => {
                setMessages([
                    {
                        id: "1",
        ...
        <div className="min-h-screen bg-gradient-to-b from-[#0A0A0B] to-black">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-12 md:mb-20">
                    {[
                        {
                            icon: <Shield className="w-6 h-6 text-yourbot-primary" />,
                            title: "Auto-Moderation",
                            description:
                                "Automatically detect and handle spam, inappropriate content, and raids"
                        },
                        {
                            icon: <MessageSquare className="w-6 h-6 text-yourbot-primary" />,
                            title: "Message Filtering",
                            description:
                                "Filter unwanted content, links, and attachments with customizable rules"
                        },
                        {
                            icon: <UserX className="w-6 h-6 text-yourbot-primary" />,
                        ...
                        {
                            icon: <AlertTriangle className="w-6 h-6 text-yourbot-primary" />,
                            title: "Raid Protection",
                            description: "Advanced algorithms to detect and prevent raid attempts"
                        },
                        {
                            icon: <Ban className="w-6 h-6 text-yourbot-primary" />,
                    ...
                    <motion.div
                        ...
                        <div className="border-b border-white/5 p-4 md:p-6">
                            ...
                            <p className="text-white/60 text-sm md:text-base">
                                Fine-tune your server&apos;s protection settings
                            </p>
                        </div>
                                        ...
                                        {tabs.map(tab => (
                                            <motion.button
                                                ...
                                                className={`flex items-center gap-2 px-4 py-3 text-sm font-medium transition-colors
                                                    ${
                                                        activeTab === tab.key
                                                            ? "text-white border-b-2 border-yourbot-primary"
                                                            : "text-white/40 hover:text-white/60"
                                                    }`}>
                                                <div className="p-2 bg-gradient-to-br from-white/10 to-transparent rounded-xl w-fit">
                                                    {tab.icon}
                                                </div>
                                                {tab.title}
                                            </motion.button>
                                            ...
                                            <motion.div
                                                ...
                                                <div className="bg-black/20 rounded-lg p-3">
                                                    <div className="flex items-center justify-between mb-2">
                                                        ...
                                                        <span className="text-sm font-medium text-yourbot-primary">
                                                            {selectedPreset === "strict"
                                                                ? "98%"
                                                                : selectedPreset === "medium"
                                                                  ? "85%"
                                                    ...
                                                    <div className="h-1 bg-white/5 rounded-full overflow-hidden">
                                                        <motion.div
                                                            ...
                                                            className="h-full rounded-full bg-yourbot-primary"
                                                        />
                                                    </div>
                                                </div>
                                            </motion.div>
                                    ...
                                    <div className="space-y-6 mt-2">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <input
                                                ...
                                                className="w-full accent-yourbot-pink appearance-none bg-white/5 h-1 rounded-lg focus:outline-none"
                                                style={{
                                        ...
                                        {demoMessages.map((msg, i) => (
                                            <motion.div
                                                ...
                                                className={`p-3 rounded-lg transition-all duration-200 hover:bg-white/[0.03] group ${
                                                    msg.type === "system"
                                                        ? "bg-yourbot-pink/10 text-yourbot-pink border border-yourbot-pink/10"
                                                        : msg.type === "warning"
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <motion.div
                                                        ...
                                                        {msg.type === "system" && (
                                                            <Shield className="w-4 h-4 text-yourbot-pink" />
                                                        )}
                                                    </motion.div>
                                            ...
                                            className={`group relative flex items-start gap-3 p-3 rounded-xl transition-all 
                                                ...
                                                ${
                                                    message.author === "System"
                                                        ? "bg-gradient-to-r from-yourbot-pink/10 to-transparent"
                                                        : "hover:bg-white/5"
                                                }`}>
                                            <div
                                                ...
                                                ${
                                                    message.author === "System"
                                                        ? "from-yourbot-pink/20 to-yourbot-pink/5"
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                        {[
                            ...
                            <motion.div
                                ...
                                <div className="text-yourbot-primary/60 font-bold mb-2">
                                    Step {step.step}
                                </div>
                                <h3 className="text-xl font-semibold text-yourbot-primary mb-2">
                                    {step.title}
                                </h3>
                ...
                <motion.div
                    ...
                    <div className="relative">
                        <span className="text-4xl font-bold bg-gradient-to-r from-white to-yourbot-primary bg-clip-text text-transparent mb-4 block">
                            Start Your Moderation Journey
                        </span>
                        <div className="flex flex-col lg:flex-row items-center gap-8 mt-8">
                            <div className="flex-1 space-y-4">
                                <p className="text-white/60 text-xl">
                                    Join thousands of servers already using yourbot&apos;s
                                    moderation system
                                </p>
