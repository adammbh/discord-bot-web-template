                    ...
                    <div className="relative border-b border-white/5 bg-black/20">
                        ...
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pt-24 relative">
                            <div className="text-center">
                                <span className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4 md:mb-6 bg-gradient-to-r from-white to-yourbot-primary bg-clip-text text-transparent block">
                                    Commands
                                </span>
                        ...
                        <div className="flex flex-col md:flex-row md:items-center gap-4">
                            <div className="relative flex-grow">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <Search className="h-5 w-5 text-yourbot-primary/40" />
                                </div>
                                <input
                                    type="text"
                                    placeholder="Search commands by name, description, or aliases..."
                                    className="w-full bg-yourbot-200 border border-yourbot-card-border rounded-full pl-10 pr-4 py-3 text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-white/20 transition-all"
                                    value={searchQuery}
                            ...
                            <div className="relative" ref={filterRef}>
                                <button
                                    ...
                                    <Filter className="w-4 h-4 text-yourbot-primary/80" />
                                    <span>
                                        Filter by Category
                                                ...
                                                <button
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        <span
                                                            className={
                                                                activeCategory === category.name
                                                                    ? "text-yourbot-primary"
                                                                    : "text-yourbot-primary/40"
                                                            }>
                                                            {category.icon}
                                                        </span>
                                                    ...
                                                    <span className="text-xs px-1.5 py-0.5 rounded-full bg-yourbot-primary/10 text-yourbot-primary/80 border border-yourbot-primary/20">
                        ...
                        {visibleCommands.length > 0 ? (
                            ...
                            <div className="flex flex-col items-center justify-center p-12 text-center bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl">
                                <div className="bg-white/5 p-4 rounded-full mb-4">
                                    <Search className="w-8 h-8 text-yourbot-primary/80" />
                                </div>
                        ...
                        {selectedCommand && (
                            <motion.div
                                ...
                                <motion.div
                                    ...
                                    className="w-full max-w-2xl bg-yourbot-200 border border-yourbot-card-border rounded-xl overflow-hidden"
                                    ...
                                    <div className="p-6">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <button
                                                onClick={() => setSelectedCommand(null)}
                                                className="p-2 rounded-lg bg-yourbot-400 hover:bg-yourbot-300 transition-colors"
                                                title="Close"
                                                aria-label="Close">
                                        ...
                                        <div className="mt-6 space-y-6">
                                            <div className="bg-yourbot-400 rounded-xl p-4">
                                                ...
                                                <div className="bg-yourbot-300 rounded-lg p-4 font-mono text-white/70 border border-yourbot-card-border overflow-x-auto">
                                                    <code>
                                                        {selectedCommand.name}{" "}
                                                    ...
                                                    <div className="space-y-3">
                                                        {selectedCommand.parameters.map(
                                                            (param, idx) => (
                                                                <div
                                                                    key={idx}
                                                                    className="p-4 rounded-lg bg-yourbot-300 border border-yourbot-card-border">
                                                    ...
                                                    <div className="flex flex-wrap gap-2">
                                                        {selectedCommand.permissions.map(
                                                            permission => (
                                                                <span
                                                                    key={permission}
                                                                    className="px-3 py-1.5 rounded-md text-sm bg-yourbot-300 text-white/70 border border-yourbot-card-border">
                                                                    {permission}
                                                                </span>
                                                            )
                                                        )}
...
const CommandCard = React.memo(
    ({
        ...
        return (
            <div
                onClick={onClick}
                className="relative h-full bg-yourbot-200 border border-yourbot-card-border hover:border-white/20 rounded-xl transition-all cursor-pointer">
                {command.donator && (
                ...
                <div className="p-5 h-full flex flex-col">
                    <div className="flex items-start justify-between mb-3">
                        <div className="flex items-center gap-2">
                            ...
                            <button
                                ...
                                <Copy size={14} className="text-yourbot-primary/80" />
                            </button>
                        </div>
                    ...
                    <div className="flex items-center justify-between mt-auto pt-2">
                        <div className="flex items-center gap-1">
                            <span className="px-2 py-0.5 text-xs rounded-full bg-yourbot-400 text-yourbot-primary/80 border border-yourbot-card-border">
                                {command.category}
                            </span>
                        </div>
                        ...
                        <div className="text-sm text-white/50">
                            <div className="flex items-center gap-1">
                                <ExternalLink size={12} className="text-yourbot-primary/80" />
                                <span>Details</span>
                            </div>
                        </div>
                    </div>
