...
function TeamMemberCard({ presenceData }: { presenceData: UserData }) {
    ...
    return (
        <div className="bg-yourbot-200 border border-yourbot-card-border rounded-xl p-5 flex flex-col h-full">
            <div className="flex-1 flex gap-3 mb-2">
                <div className="relative flex-shrink-0 self-start">
                    ...
                    {presenceData.discord_status !== "offline" && (
                        <div
                            className={`absolute right-0 bottom-0 w-[12.5px] h-[12.5px] rounded-full ${statusColor} ring-[1px] ring-yourbot-200`}
                        />
                    )}
                </div>
...
export default function TeamPage() {
    ...
    useEffect(() => {
        ...
        fetch("https://api.yourbot.bot/users/presence", { headers })
            .then(res => res.json())
            ...
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 py-8">
                <div className="mb-12">
                    ...
                    <p className="text-white/60 text-center mb-8">
                        The core development team behind yourbot
                    </p>
