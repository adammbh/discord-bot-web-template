            ...
            <main className="relative z-10">
                <div className="flex flex-col mx-[10vw] mt-20 sm:mx-[25vw]">
                    ...
                    <span className="text-neutral-400 text-sm mt-5 pb-5">
                        By visiting (&apos;Your Bot&apos;) or inviting (&apos;Your Bot&apos;) to your
                        Discord or logging into our website (&apos;your.bot&apos;), you agree and
                        consent to the terms displayed on this page including our policies (Privacy
                        Policy). When we state &apos;Your Bot&apos;, &apos;we&apos;, &apos;us&apos;,
                        and &apos;our&apos; in these terms, we mean Your Bot. &apos;Services&apos; mean
                        Your Bot&apos;s services that we offer to users.
                    </span>
                    ...
                    <span className="text-neutral-400 text-sm mt-5">
                        You may not use Your Bot to violate any applicable laws or regulations as well
                        ...
                        <span className="text-white font-semibold">support@your.bot</span>. If you
                        are refunded under any circumstances, your Discord account may be subject to
                        blacklist and a ban from all of our services.
                    </span>
                    <span className="font-bold text-2xl text-white pt-10">Your Bot Website Usage</span>
                    <span className="text-neutral-400 text-sm mt-5">
                    ...
                    <div className="flex flex-col gap-4 text-[17px] pl-5 pt-5">
                        ...
                        <li className="text-neutral-400 marker:text-yourbot-pink">
                            Copy Your Bot&apos;s website and claiming it as your own work.
                        </li>
                        <li className="text-neutral-400 marker:text-yourbot-pink">
                    ...
                    <span className="font-bold text-2xl text-white pt-10">Your Bot Bot Usage</span>
                    <span className="text-neutral-400 text-sm mt-5">
                    ...
                    <div className="flex flex-col gap-4 text-[17px] pl-5 pt-5">
                        ...
                        <li className="text-neutral-400 marker:text-yourbot-pink">
                            Copy Your Bot&apos;s services or features.
                        </li>
                        <li className="text-neutral-400 marker:text-yourbot-pink">
                            Assist anyone in copying Your Bot&apos;s services or features.
                        </li>
                        <li className="text-neutral-400 marker:text-yourbot-pink">
                            Abuse or exploit Your Bot or any of our services.
                        </li>
                        <li className="text-neutral-400 marker:text-yourbot-pink">
