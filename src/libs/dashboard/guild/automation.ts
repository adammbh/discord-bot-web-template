...
export async function fetchGuildAutomation(guildId: string): Promise<AutomationResponse> {
    ...
    const response = await fetch(`https://api.yourbot.bot/automation`, {
        headers: {
...
export async function updateGuildAutomation(
    guildId: string,
    ...
    const response = await fetch(`https://api.yourbot.bot/update/automation`, {
        method: "POST",
        headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
